...
export default function (data) {
    ...
    const updatedName = 'Bruno Update 3'

    let res = http.patch(`https://test-api.k6.io/my/crocodiles/${newCrocodileId}/`,
        JSON.stringify(
            {
                name: updatedName
            }
    ...
    check(res, {
        ...
        'check updated name': (value) => value.json().name === updatedName
    });
